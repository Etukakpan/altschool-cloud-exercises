...
- Demo Project: https://github.com/Etukakpan/laravel-realworld-example-app.git
...
![Laravel RealWorld Example App](images/laravel-logo.png)
...
After installation is completed, the below command will prompt the installed version of Git in the AWS server.
...
![Laravel RealWorld Example App](images/apv.png) (images/apv1.png)
...
Next we will clone the Laravel Project int the present working direcctory
    ...
    $ sudo git clone - https://github.com/Etukakpan/laravel-realworld-example-app.git
...
![Laravel RealWorld Example App](images/m4.png)
...
![Laravel RealWorld Example App](images/m7.png)

    $ sudo mysql_secure_installation

**Input the password you setup during the Installation of MySQL**

![Laravel RealWorld Example App](images/m8.png)
...
![Laravel RealWorld Example App](images/m10.png)
...
![Laravel RealWorld Example App](images/all.png)

![Laravel RealWorld Example App](images/ty.png)
...
![Laravel RealWorld Example App](images/database.png)
...
![Laravel RealWorld Example App](images/w4.png)
...
![Laravel RealWorld Example App](images/addy.png)
